...
;; Takes 2 addresses as arguments, and swaps the 4-byte signed
;; integer values at both addresses.
;; function swapValues
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
swapValues:
	...
	mov 	eax, [ebp+12] 			; swap1 address
	mov 	ebx, dword [eax] 		; swap1 value
	mov 	ecx, [ebp+8] 			; swap2 address
	mov 	edx, dword [ecx] 		; swap2 value

	mov 	dword [eax], edx 		; move swap2 value into swap1 address
	mov 	dword [ecx], ebx 		; move swap1 value into swap2 address
